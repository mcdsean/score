...
# 2013-04-15 smcdonagh@keywcorp.com: reviewed and added exit(1)
# 2013-03-04 rhsteve@nsa.gov: modified get_primary_testcase_filename_regex() to reflect addition of flow variants 83 and 84 in 2012. updated negative lookahead to avoid "catching" 83_bad and 84_bad since primary files for those flow variants are 83a and 84a. 
# 2013-02-18 jspielvogel@keywcorp.com: updated so that the split test cases are placed into directories named s01, s02, etc., moved update_split_test_case_package_name() to Java's split_cwe_dirs.py
# 2012-12-18 jspielvogel@keywcorp.com: modified run_analysis() so that we no longer use a glob needle, updated convertSecondsToDHMS() to return the converted seconds as a string instead of printing it to the console
# 2012-17-17 jspielvogel@keywcorp.com: added get_tool_study_max_java_heap_size()
# 2012-12-13 jspielvogel@keywcorp.com: added more getter methods to retrieve common, fixed strings used throughout our scripts
# 2012-11-09 rhsteve@nsa.gov:  added function to convert seconds to days/hours/minutes/seconds (convertSecondsToDHMS)
# 2012-11-06 jspielvogel@keywcorp.com: modified move_testcase_to_split_directories() to use a threshold rather than moving test cases to a directory per functional variant - this method ensures all test case files for a given functional variant remain in the same directory
# 2012-09-28 jspielvogel@keywcorp.com: added get_c_and_cpp_testcasesupport_dir, get_c_and_cpp_testcasesupport_dir_split, and get_testcase_subdirectory_regex
# 2012-08-02 jspielvogel@keywcorp.com: move_testcase_to_split_directories generates more meaningful logging information
# 2012-07-13 jspielvogel@keywcorp.com: added JAVA_MAIN_COMMENT and C_CPP_MAIN_COMMENT - kept these separate even though they contain the same comment right now just in case that changes
# 2012-06-22 jspielvogel@keywcorp.com: added more functions that are common among our scripts
# 2012-05-24 jspielvogel@keywcorp.com: added encode_language()
# 2012-05-18 jspielvogel@keywcorp.com: added get_cwe_id_regex()
# 2012-01-04 pmkulin@nsa.gov: convert concatenate_csvs to streaming
# 2011-12-05 chuck.willis@mandiant.com: updated get_primary_testcase_filename_regex() to account for CWE580_Clone_Without_Super that has a "_bad" and an "a" file
# 2011-12-05 chuck.willis@mandiant.com: updated get_primary_testcase_filename_regex() to not "catch" 81_bad and 82_bad since the primary files for those flow variants are 81a and 82b
# 2011-11-22 jspielvogel@sycamore.us: updated get_primary_testcase_filename_regex() to reflect changes to get_testcase_filename_regex()
# 2011-11-17 chuck.willis@mandiant.com: Updated get_testcase_filename_regex() to handle base, goodB2G, and goodG2B
# 2011-11-09 jspielvogel@sycamore.us: added timestamps to run_commands, added print_with_timestamp function
# 2011-10-11 chuck.willis@mandiant.com: Updated test case file regex to handle .h files for C++ test cases
# 2011-01-28 jspielvogel@sycamore.us: added add_unique_finding_ids
# 2011-01-27 jspielvogel@sycamore.us: moved several functions here from massage_data, added generate_unique_finding_ids
# 2010-09-09 john.laliberte@mandiant.com: consolidate / fix regexes
# 2010-09-08 john.laliberte@mandiant.com: fix redirection problem
# 2010-09-02 john.laliberte@mandiant.com: added time tracking to run analysis function
# 2010-08-31 john.laliberte@mandiant.com: added function to transform a csv in streaming fashion
# 2010-08-25 john.laliberte@mandiant.com: move run_analysis functions into here
# 2010-08-05 john.laliberte@mandiant.com: add function to get files in a directory (non-recursively)
# 2010-08-02 john.laliberte@mandiant.com: modify get_timestamp so it outputs leading 0's for days and months.  Added run_commands.  Add function to get directories matching regex.  Add write_file function
# 2010-07-02 john.laliberte@mandiant.com: add more common functions
# 2010-07-01 john.laliberte@mandiant.com: initial version, take and modify functions from other scripts
...
def get_primary_testcase_filename_regex():
	...
	The "(?!8[1234]_bad)" is a "negative lookahead" so that we don't 
	get the 81_bad, 82_bad, 83_bad, or 84_bad file as the primary since 
	those flow variants also have an "a" file (which is the primary file)
...
def extract_cwe_id_from_path(path):
	...
	# and the sub-directory name is a number (01, 02, etc.) so we append this string
